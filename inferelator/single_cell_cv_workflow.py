        ...
        for s_ratio in self.sizes:
            for seed in self.seeds:
                ...
                if self.write_network:
                    ...
                    puppet.precision_recall_file_name = "precision_recall_{size}_s{seed}.tsv".format(size=s_ratio,
                                                                                                     seed=seed)
                puppet.run()
    ...
    def auprs_for_index(self, r_name, r_idx, sample_size=None):
        ...
        for seed in self.seeds:
            ...
            if self.write_network:
                ...
                puppet.precision_recall_file_name = "precision_recall_{drop}_s{seed}.tsv".format(drop=r_name, seed=seed)
            puppet.run()
