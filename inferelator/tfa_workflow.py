...
class TFAWorkFlow(workflow.WorkflowBase):
    ...
    def compute_activity(self):
        ...
        tfa_calculator = self.tfa_driver()
        self.design = tfa_calculator.compute_transcription_factor_activity(self.priors_data,
                                                                           self.design,
    ...
    def compute_common_data(self):
        ...
        if self.drd_driver is not None:
            ...
            self.design, self.response, self.half_tau_response = drd.run(self.data)
        else:
