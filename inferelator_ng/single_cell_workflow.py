...
# It's just less work to troubleshoot a factory method than some complex multi-inheritance scheme
def single_cell_workflow(work_type):
    class SingleCellWorkflow(work_type):
        # Gene list
        gene_list_file = None
        gene_list = None
